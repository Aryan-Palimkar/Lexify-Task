        ...
        <div className="w-full max-w-md">
          <div className="bg-gradient-to-r from-sky-100 to-blue-50 rounded-xl shadow-lg overflow-hidden border border-sky-200 p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-sky-700 mb-2">Login</h1>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" required className="block w-full pl-10 pr-3 py-3 border-0 text-gray-700 bg-white bg-opacity-70 backdrop-blur-sm rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500" placeholder="your@email.com" value={email} onChange={(e) => setEmail(e.target.value)}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="password" required className="block w-full pl-10 pr-3 py-3 border-0 text-gray-700 bg-white bg-opacity-70 backdrop-blur-sm rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
              </div>
